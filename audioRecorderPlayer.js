import {
  ...
  class AudioRecorderPlayer {
    ...
    */
    ...
    startRecorderAndStartPlayer = async(delaytime) => {
      return await RNAudioRecorderPlayer.startRecorderAndStartPlayer(delaytime);
    }
    releaseRecorderAndReleasePlayer = async() => {
      return await RNAudioRecorderPlayer.releaseRecorderAndReleasePlayer();
    }
  }
